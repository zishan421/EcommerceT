...
const settings = {
  ...
  slidesToShow: 5,
  slidesToScroll: 3,
  nextArrow: <button type='button' className={`${arrowStyle} right-4`}><FaArrowRight /></button>,
  prevArrow: <button type='button' className={`${arrowStyle} right-18`}><FaArrowLeft /></button>,
}
